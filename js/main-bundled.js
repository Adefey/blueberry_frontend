  ...
  (() => {
    ...
    function h() {
      (t.innerHTML = ""),
        ...
        t.querySelector(".button-add-recipe").addEventListener("click", (n) => {
          const r = t.querySelector(".recipe-name").value,
            o = t.querySelector(".recipe-description").value,
            a = t.querySelector(".recipe-image-url").value;
          console.log("Collected general data", r, o, a);
          let l = Array.from(t.querySelectorAll(".step-name"));
          l && (l = l.map((e) => e.value));
          let i = Array.from(t.querySelectorAll(".step-description"));
          i && (i = i.map((e) => e.value));
          let s = Array.from(t.querySelectorAll(".step-duration"));
          s && (s = s.map((e) => e.value));
          let c = Array.from(t.querySelectorAll(".step-image-url"));
          c && (c = c.map((e) => e.value)),
            console.log("Collected step data", l, i, s, c),
            (async function (t, n, r, o, a, l, i) {
              const s = "/recipe";
              console.log(s);
              const c = o.map((e, t) => ({
                caption: o[t],
              ...
              try {
                ...
                return (
                  console.error("Error loading data for", s, "Error:", e), null
                );
              }
            })(r, o, a, l, i, s, c)
              .then((e) => {
