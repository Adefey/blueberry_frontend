  ...
  (() => {
    ...
    function u() {
      (t.innerHTML = ""),
        ...
        (function () {
          t.insertAdjacentHTML("beforeend", o({ value: c.searchQuery }));
    ...
    function v(n) {
      console.log(`Running recipe list received callback, total: ${n.total}`),
        ...
        (function () {
          ...
          0 === c.currentPage && (e.disabled = !0);
          const n = t.querySelector(".button-next-list");
          c.currentPage === c.totalPages - 1 && (n.disabled = !0);
        })();
    }
    function m(e, n) {
