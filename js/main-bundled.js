        ...
        e.exports = (n.default || n).template({
          ...
          main: function (e, t, n, o, a) {
            ...
            return (
              ...
              '</div>\n    </div>\n  </div>\n  <div class="flex-row buttons-bar">\n    <div class="timer shadow-border"><div>Timer:\n        ' +
              s(
            ...
            return (
              ...
              e.escapeExpression(
                "function" ==
                  typeof (a =
                    null !=
                    (a = l(r, "value") || (null != t ? l(t, "value") : t))
                      ? a
  ...
  (() => {
    ...
    function s() {
      (t.innerHTML = ""),
        ...
        })(l, i.currentPage * l, i.lastSearchQuery)
          .then((r) => {
            console.log("Data received by main JS", r),
              (i.recipeListData = r),
              (i.totalRecipes = r.total),
              (i.totalPages = Math.ceil(i.totalRecipes / l)),
              console.log(
                "Total recipes:",
                i.totalRecipes,
                "Total pages:",
              ...
              (t.innerHTML += o(i.recipeListData));
            const n = t.querySelector(".button-prev-list");
            0 === i.currentPage
              ? (n.disabled = !0)
            ...
            i.currentPage === i.totalPages - 1
              ? (a.disabled = !0)
              : a.addEventListener("click", () => {
                  ++i.currentPage, s();
                });
            const c = t.querySelector(".searchbar");
            t.querySelector(".button-search").addEventListener("click", () => {
              (i.lastSearchQuery = c.value), s();
            }),
              t.querySelectorAll(".recipe-container").forEach((r) => {
    ...
    function u(e) {
      t.innerHTML = a(e.steps[i.currentStep]);
      const r = t.querySelector(".timer");
      let n = e.steps[i.currentStep].duration,
        o = setInterval(() => {
          (r.innerHTML =
            "Timer: " +
            (function (e) {
            ...
            0 === n &&
              i.currentStep !== e.steps.length - 1 &&
              (++i.currentStep, console.log("Next slide"), u(e)),
            --n;
        }, 1e3);
      setTimeout(
        () => {
        ...
        1e3 * (e.steps[i.currentStep].duration + 2),
      );
      const l = t.querySelector(".button-previous");
      0 === i.currentStep
        ? (l.disabled = !0)
        : l.addEventListener("click", (t) => {
            clearInterval(o), --i.currentStep, u(e);
          }),
        t.querySelector(".button-pause").addEventListener("click", (e) => {
          clearInterval(o), (r.innerHTML = "Cook as you feel");
        });
